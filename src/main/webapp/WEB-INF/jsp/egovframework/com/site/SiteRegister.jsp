...
<c:set var="registerFlag" value="${siteVO.seq == 0 ? '등록' : '수정'}"/>			
<script
...
<form:form commandName="siteVO" name="detailForm" id="detailForm" enctype="multipart/form-data" >
<form:input type="hidden" id="userSeq" path="userSeq" value="${userSeq}"/>
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
