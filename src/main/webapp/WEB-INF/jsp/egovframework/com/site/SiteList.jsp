					...
					<c:forEach var="result" items="${resultList}" varStatus="status">
						<tr>
							<td align="center" class="listtd"><a
								href="javascript:fn_egov_select('<c:out value="${result.seq}"/>')"><c:out
										value="${result.seq}" /></a>&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.userSeq}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.url}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.version}" />&nbsp;</td>
							<td align="center" class="listtd"><a
							...
							<td align="center" class="listtd"><c:out
									value="${result.filePath}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.ctime}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.cdate}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.utime}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.udate}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.dtime}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.ddate}" />&nbsp;</td>
						</tr>
					</c:forEach>
				</table>
			</div>
